...
% Kinematic model
global alpha1 alpha2 dCB1o dCB2o a1 a2 a3 a4 a5 Dw Lw1 Lw2     
% Heat transfer model
global ha_1 hb_1 ha_2 hb_2 ha_1c hb_1c ha_2c hb_2c Tamb dens
...
bat_Volt = 12;
%thetaT = 550000;         % Thermoelastic tensor (due to the particular SMA
...
% HEAT TRANSFER MODEL
Tamb = 25;          % Initial (ambient) temperature [deg]
...
epsR1 = 0.036;              % SMA1 max. recovery strain
epsR2 = 0.036;              % SMA2 max. recovery strain
Rw = 8.66;                  % Electric resistence per unit length [Ohm/m]
Dw = 0.00031;              % Diameter [m]
Lw1 = 0.18;                % SMA1 undeformed lenght [m]
Lw2 = 0.18;                % SMA2 undeformed lenght [m]
